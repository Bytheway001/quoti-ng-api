...
final class CreateRates extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('rates',['collation'=>'utf8_spanish2_ci']);
        $table->addColumn('plan_id','integer',['limit'=>11])
        ->addColumn('min_age','integer',['limit'=>2])
        ->addColumn('max_age','integer',['limit'=>2])
